...
Definition test_wikipedia :=
  (BI_get_local 0
   ...
   :: BI_if (Tf nil (T_i64 :: nil))
        (BI_const (VAL_int64 numerics.Wasm_int.Int64.one) :: nil)
        (BI_get_local 0
         :: BI_get_local 0
         :: BI_const (VAL_int64 numerics.Wasm_int.Int64.one)
...
Definition module_42 := {|
  mod_types := cons (Tf nil (cons T_i32 nil)) nil;
  mod_funcs :=
    let e := BI_const (VAL_int32 (numerics.Wasm_int.Int32.repr (BinInt.Z.of_nat 42))) in
